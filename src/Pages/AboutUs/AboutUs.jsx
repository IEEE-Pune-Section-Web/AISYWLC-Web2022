    ...
    <>
      <Container className="main">
        ...
        <div className="about_card">
          <div className="content">
            <h3>
              IEEE Pune Section was established on June 26, 2010
              with terrestrial boundaries confined to Pune metropolitan
              City(Postal Code 411001 to 411999) The section falls under the
              jurisdiction of Asia Pacific Region (R-10) of IEEE. Prior to that
              it was the subsection of IEEE Bombay section since June 20, 2003
              till its formation. At present, the Pune section has more than 300
              ...
              <a href="ieeepunesection.org" target='blank'> ieeepunesection.org</a>
